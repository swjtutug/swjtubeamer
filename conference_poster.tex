...
\usepackage[scale=1.24]{source/beamerposter} % Use the beamerposter package for laying out the poster
...
\title{Simple Conference Poster with Dalhousie Colours} % Poster title

\author{Abraham Nunes$^{1,2}$} % Author(s)

\institute{$^{1}$First Institution Here \\ [0.5ex]
		   $^{2}$Second Institution Here} % Institution(s)
...
\bibliography{source/conference_poster}\vspace{0.75in}}
